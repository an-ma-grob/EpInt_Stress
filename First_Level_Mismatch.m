%% Model specification for Mismatch analyses %% 
...
spm_jobman('initcfg');
always = '...\EPINT_';
MCF_files = '...\Paradigmen\Sims_Task\log\MCF_Mismatch';
...
% clear matlabbatch;
Analysis = char(strcat('...\Analysis\Sims\Mismatch',filesep,char(names(i))));
...
matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'Link_bigger_Control';
matlabbatch{1}.spm.stats.con.consess{1}.tcon.convec = [0 0 0 1 -1 (zeros(5,1)') 1 -1 (zeros(5,1)') 1 -1 (zeros(5,1)') 1 -1 (zeros(5,1)') 1 -1 (zeros(5,1)') 1 -1 0 0 0];
