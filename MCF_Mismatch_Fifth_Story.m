...
Help = zeros(48,9)';
Help(1,1:48) = [Pre_onsets_A_3(1:6), Pre_Link_3(1:6), Pre_NonLink_3(1:6),Linking_Event_3(1:6), Control_Event_3(1:6),...
    Post_onsets_A_3(1:6), Post_Link_3(1:6), Post_NonLink_3(1:6)];
...
%% Make Main regressor
% Fifth Story regressor
names{1} = [Fifth, '_Events'];
onsets{1}=sort([Pre_onsets_A_3(1:6) + diff_blocks(2) + diff_blocks(4), Pre_Link_3(1:6) + diff_blocks(2) + diff_blocks(4), Pre_NonLink_3(1:6) + diff_blocks(2) + diff_blocks(4),Linking_Event_3(1:6) + diff_blocks(2) + diff_blocks(4), Control_Event_3(1:6) + diff_blocks(2) + diff_blocks(4),...
    Post_onsets_A_3(1:6) + diff_blocks(2) + diff_blocks(4), Post_Link_3(1:6) + diff_blocks(2) + diff_blocks(4), Post_NonLink_3(1:6) + diff_blocks(2) + diff_blocks(4)]);
durations{1}=[(zeros(18,1))',(zeros(12,1))',(zeros(18,1))'];

cd(Story);
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fifth,'_',name,' names onsets durations']);
elseif i == 38
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fifth,'_Pre_AB_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fifth,'_Pre_AB_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fifth,'_Pre_AX_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fifth,'_Pre_AX_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fifth,'_Link_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fifth,'_Link_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fifth,'_Control_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fifth,'_Control_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fifth,'_Post_AB_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fifth,'_Post_AB_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fifth,'_Post_AX_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fifth,'_Post_AX_',name,' pmod']);
elseif i == 58
