...
Help = zeros(48,9)';
Help(1,1:48) = [Pre_onsets_A_1(1:6), Pre_Link_1(1:6), Pre_NonLink_1(1:6),Linking_Event_1(1:6), Control_Event_1(1:6),...
    Post_onsets_A_1(1:6), Post_Link_1(1:6), Post_NonLink_1(1:6)];
...
%% Make Main regressor
names{1} = [First, '_Events'];
onsets{1}=sort([Pre_onsets_A_1(1:6),  Pre_Link_1(1:6), Pre_NonLink_1(1:6),Linking_Event_1(1:6), Control_Event_1(1:6),...
    Post_onsets_A_1(1:6), Post_Link_1(1:6), Post_NonLink_1(1:6)]);
...
eval(['save MCF_',First,'_',name,' names onsets durations']);
elseif i == 38
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',First,'_Pre_AB_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',First,'_Pre_AB_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',First,'_Pre_AX_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',First,'_Pre_AX_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',First,'_Link_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',First,'_Link_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',First,'_Control_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',First,'_Control_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',First,'_Post_AB_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',First,'_Post_AB_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',First,'_Post_AX_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',First,'_Post_AX_',name,' pmod']);
elseif i == 58
