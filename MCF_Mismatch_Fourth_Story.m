...
Help = zeros(48,9)';
Help(1,1:48) = [Pre_onsets_A_2(7:12), Pre_Link_2(7:12), Pre_NonLink_2(7:12),Linking_Event_2(7:12), Control_Event_2(7:12),...
    Post_onsets_A_2(7:12), Post_Link_2(7:12), Post_NonLink_2(7:12)];
...
%% Make Main regressor
% Fourth Story regressor
names{1} = [Fourth, '_Events'];
onsets{1}=sort([Pre_onsets_A_2(7:12) + diff_blocks(2), Pre_Link_2(7:12) + diff_blocks(2), Pre_NonLink_2(7:12) + diff_blocks(2),Linking_Event_2(7:12) + diff_blocks(2), Control_Event_2(7:12) + diff_blocks(2),...
    Post_onsets_A_2(7:12) + diff_blocks(2), Post_Link_2(7:12) + diff_blocks(2),  Post_NonLink_2(7:12) + diff_blocks(2)]);
durations{1}=[(zeros(18,1))',(zeros(12,1))',(zeros(18,1))'];

cd(Story);
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fourth,'_',name,' names onsets durations']);
elseif i == 38
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fourth,'_Pre_AB_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fourth,'_Pre_AB_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fourth,'_Pre_AX_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fourth,'_Pre_AX_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fourth,'_Link_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fourth,'_Link_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fourth,'_Control_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fourth,'_Control_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fourth,'_Post_AB_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fourth,'_Post_AB_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Fourth,'_Post_AX_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Fourth,'_Post_AX_',name,' pmod']);
elseif i == 58
