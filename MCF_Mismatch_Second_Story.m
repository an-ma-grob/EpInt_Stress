...
Help = zeros(48,9)';
Help(1,1:48) = [Pre_onsets_A_1(7:12), Pre_Link_1(7:12), Pre_NonLink_1(7:12),Linking_Event_1(7:12), Control_Event_1(7:12),...
    Post_onsets_A_1(7:12), Post_Link_1(7:12), Post_NonLink_1(7:12)];
...
%% Make Main regressor
% Second Story regressor
names{1} = [Second, '_Events'];
onsets{1}=sort([Pre_onsets_A_1(7:12), Pre_Link_1(7:12), Pre_NonLink_1(7:12),Linking_Event_1(7:12), Control_Event_1(7:12),...
    Post_onsets_A_1(7:12), Post_Link_1(7:12), Post_NonLink_1(7:12)]);
...
eval(['save MCF_',Second,'_',name,' names onsets durations']);
elseif i == 38
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Second,'_Pre_AB_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Second,'_Pre_AB_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Second,'_Pre_AX_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Second,'_Pre_AX_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Second,'_Link_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Second,'_Link_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Second,'_Control_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Second,'_Control_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Second,'_Post_AB_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Second,'_Post_AB_',name,' pmod']);
elseif i == 58
...
if i == 1
name = ['001_',Experiment.Log.participantName];
eval(['save MCF_',Second,'_Post_AX_',name,' pmod']);
elseif i == 38
name = ['038_',Experiment.Log.participantCode];
eval(['save MCF_',Second,'_Post_AX_',name,' pmod']);
elseif i == 58
